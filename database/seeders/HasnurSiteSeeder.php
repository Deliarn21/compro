...
class HasnurSiteSeeder extends Seeder
{
    ...
    {
        $items = [
            'logistics' => ['title' => 'Logistics', 'subtitle' => 'Integrated maritime and supply chain operations', 'summary' => 'Pilar logistik yang menegaskan kekuatan shipping, hauling, dan operasi rantai pasok.', 'legacy_path' => 'page/our-business/logistic', 'accent' => '#0d9488'],
            'agribusiness-forestry' => ['title' => 'Agribusiness & Forestry', 'subtitle' => 'Sustainable plantation and forestry value chain', 'summary' => 'Pilar agribisnis dan kehutanan yang menonjolkan keseimbangan produktivitas dan keberlanjutan.', 'legacy_path' => 'page/our-business/agribusiness-forestry', 'accent' => '#3f6212'],
            'energy' => ['title' => 'Energy', 'subtitle' => 'Mining operations and renewable transition roadmap', 'summary' => 'Pilar energi untuk kinerja operasional dan kesiapan menghadapi masa depan energi.', 'legacy_path' => 'page/our-business/energy', 'accent' => '#b45309'],
            'technology-services' => ['title' => 'Technology & Services', 'subtitle' => 'Digital solutions and managed services', 'summary' => 'Unit teknologi yang memperkuat efisiensi dan transformasi digital grup.', 'legacy_path' => 'page/our-business/technology-services', 'accent' => '#0f766e'],
            'education' => ['title' => 'Education', 'subtitle' => 'Foundation, schools, and talent acceleration', 'summary' => 'Unit pendidikan yang menampilkan investasi pada manusia dan talenta masa depan.', 'legacy_path' => 'page/our-business/education', 'accent' => '#1d4ed8'],
            'consumer' => ['title' => 'Consumer', 'subtitle' => 'Media, health, and lifestyle engagement', 'summary' => 'Pilar yang paling dekat dengan publik, termasuk media, kesehatan, dan olahraga.', 'legacy_path' => 'page/our-business/consumer', 'accent' => '#be123c'],
            'investment' => ['title' => 'Investment', 'subtitle' => 'Strategic capital allocation and growth partnerships', 'summary' => 'Pilar investasi untuk strategi portofolio dan peluang pertumbuhan berikutnya.', 'legacy_path' => 'page/our-business/investment', 'accent' => '#7c3aed'],
        ];
